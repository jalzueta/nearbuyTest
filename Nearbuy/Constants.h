...
#define MAP_OVERLAY_COLOR_OFF     HSBA(25,97,75, 0.2f)
#define MAP_OVERLAY_COLOR_ON     HSBA(125,86,69, 0.2f)
#define CELL_COLOR_OFF     HSBA(25,97,75, 0.1f)
#define CELL_COLOR_ON     HSBA(125,86,69, 0.1f)